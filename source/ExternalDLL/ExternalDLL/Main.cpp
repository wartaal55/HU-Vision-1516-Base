...
int main(int argc, char * argv[]) {
	...
	ImageIO::debugFolder = "C:\\HU (school)\\jaar2\\(4) Vision\\HU-Vision-1516-Base\\source\\ExternalDLL\\Debug";
	...
	if (!ImageIO::loadImage("C:\\HU (school)\\jaar2\\(4) Vision\\HU-Vision-1516-Base\\testsets\\Set A\\TestSet Images\\child-1.png", *input)) {
